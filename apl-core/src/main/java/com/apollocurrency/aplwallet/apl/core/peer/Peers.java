...
public final class Peers {
    ...
    private static BlockJsonConverter blockJsonConverter = CDI.current().select(BlockJsonConverter.class).get();
    ...
    public static void sendToSomePeers(Block block) {
        JSONObject request = blockJsonConverter.toJson(block);
