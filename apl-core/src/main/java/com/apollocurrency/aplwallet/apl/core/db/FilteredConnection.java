...
public class FilteredConnection implements Connection {
    ...
    public FilteredConnection(Connection con, WrappedStatementFactory factory) {
        this.con = con;
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        return factory.createPreparedStatement(
                con.prepareStatement(sql, resultSetType, resultSetConcurrency), sql, factory.getStmtThreshold());
    }
    ...
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        return factory.createPreparedStatement(con.prepareStatement(sql, autoGeneratedKeys),
                sql, factory.getStmtThreshold());
    }
